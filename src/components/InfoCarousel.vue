...
export default {
  ...
  data() {
    return {
      ...
      info: [
  'חשודה - טוראי רותם בן שושן מ.א- 9753629 ת.ז- 396231467, טבחית בבח״א 10\nחשדות - אלימות כלפי חייל, הטלת מום, שיבוש הליכי חקירה ומשפט\nחוקר - רב״ט שחר שמעוני מ.א- 9354973 חוקר פלילי במצ״ח 6012\nסימוכין - מס׳ תיק- 2025/0201 מתנהל במצ״ח'
,
'במצ״ח ערבה התקבל דיווח המחשיד את טוראי רותם בן שושן באלימות כלפי חייל, הטלת מום ושיבוש הליכי חקירה. החשודה נחקרה אודות החשדות הנ״ל בתאריך 04 בדצמבר 2025 בשעה 10:36, טרם תחילת החקירה יש צורך להזהיר אותה על פי חוק.'
,  
" למלא את כלל פרטי החשוד והחוקר, להסביר את החשדות והזכויות על פי חוק. החשודה בחרה להתייעץ בעורך דין רעות כהן בין השעות 10:43-11:04. יש לחתום על כל הדברים ולציין כי גביית האמרה הועברה לכתיבה במחשב."
, 
      ],
    };
  },
